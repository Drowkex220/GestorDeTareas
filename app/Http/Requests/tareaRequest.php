...
/**
 * Clase para manejar las solicitudes de tarea.
 */
class tareaRequest extends FormRequest
{
    ...
    /**
     * Valida el formato del NIF/CIF/NIE (Número de Identificación Fiscal/Código de Identificación Fiscal/Número de Identificación de Extranjero).
     *
     * @param  string  $dni  NIF/CIF/NIE a validar.
     * @return bool  True si el NIF/CIF/NIE es válido, de lo contrario, false.
     */
