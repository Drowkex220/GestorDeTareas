...
@section('content')
    ...
    <form action="{{ route('saveTareas', ['modo' => $modo]) }}" method="POST"
        ...
        <div class="datos">
            <div>
                ...
                @error('NIF_CIF')
                   <div class="text-danger" style="color:red"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> {{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <select class="form-control" id="OperarioEncargado" name="OperarioEncargado">
                    @foreach ($operarios as $operario)
                        <option value="{{ $operario['id'] }}" {{ old('OperarioEncargado', isset($tarea) && $tarea->OperarioEncargado == $operario['id'] ? 'selected' : '') }}>
            ...
            <div>
                ...
                <input type="date" class="form-control" id="FechaCreacion" name="FechaCreacion"
                    placeholder="Fecha de creacion" value="{{ old('FechaCreacion', isset($tarea) ? $tarea->FechaCreacion : '')}}">
            ...
            <div class="datos">
                <div>
                    ...
                    <input type="text" class="form-control" id="PersonaContactoNombre" name="PersonaContactoNombre"
                        placeholder="Nombre de persona de contacto" value="{{ old('PersonaContactoNombre', isset($tarea) ? $tarea->PersonaContactoNombre : '')}}">
                ...
                <div>
                    ...
                    <input type="text" class="form-control" id="PersonaContactoApellidos"
                        name="PersonaContactoApellidos" placeholder="Apellidos de persona de contacto"
                ...
                <div>
                    ...
                    <input type="tel" class="form-control" id="TelefonoContacto" name="TelefonoContacto"
                        placeholder="Teléfono" value="{{ old('TelefonoContacto', isset($tarea) ? $tarea->TelefonoContacto : '')}}">
                ...
                <div>
                    ...
                    <input type="email" class="form-control" id="CorreoElectronico" name="CorreoElectronico"
                        placeholder="Correo Electrónico" value="{{ old('CorreoElectronico', isset($tarea) ? $tarea->CorreoElectronico : '')}}">
            ...
            <div class="datos">
                ...
                <select class="form-control" id="Provincia" name="Provincia" width="30">
                    @foreach ($provincias as $provincia)
                        <option value="{{ $provincia['codigo_ine'] }}" {{ old('Provincia', isset($tarea) && $tarea->Provincia == $provincia['codigo_ine'] ? 'selected' : '') }}>
                            {{ $provincia['nombre'] }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="number" class="form-control" id="CodigoPostal" name="CodigoPostal"
                    placeholder="Código Postal" value="{{ old('CodigoPostal', isset($tarea) ? $tarea->CodigoPostal : '')}}">
